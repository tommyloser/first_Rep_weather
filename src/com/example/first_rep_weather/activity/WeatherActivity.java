...
//			}
	...
	/**
	 * 从SharedPreferences读取存储的天气信息，并显示在界面上
	 */
	private void showWeather() {
		...
		publishText.setText(spfrs.getString("current_date", "")+"发布");
		currentDateText.setText(spfrs.getString("current_data", ""));//保存的时间
